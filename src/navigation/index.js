...
import ActiveColumn from './activeColumnNav';
...
import ColumnAddScreenContainer from '../screens/AddColumnScreen/AddColumnScreenContainer';
import TaskScreenContainer from '../screens/TaskScreen/TaskScreenContainer';
import ColumnSettingScreenContainer from '../screens/ColumnSettings/ColumnSettingScreenContainer';
  ...
  <Stack.Navigator>
    ...
    <Stack.Screen
      ...
      options={({ navigation }) => ({
        ...
        headerLeft: () => (
          <TouchableOpacity
            onPress={() => AsyncStorageService.logOut(navigation)}
            style={{ marginLeft: 15 }}
          >
